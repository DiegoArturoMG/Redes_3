...
while 1:
    ...
    ret = rrdtool.graph(NOMBRE_PNG,
      ...
      "CDEF:upper=pred,dev,0.5,*,+",
      "CDEF:lower=pred,dev,0.5,*,-",
      "CDEF:scaledupper=upper,1,*",
      "CDEF:scaledlower=lower,1,*",
      "TICK:fail#FDD017:1.0:Fallas",
      "LINE1:scaledobs#00FF00:In traffic",                        
      "CDEF:scaledpred=pred,1,*",                   
    ...
    if(falla_anterior==0 and falla_actual==1):    
      if(tiempoNow-timeOfLastSentMail > 60 * VENTANA_CORREO):      
        enviaAlerta("4CM2 Equipo 7 - Comienzo de aberracion (comportamiento anormal) detectado a las: " \
    ...
    if(falla_anterior==1 and falla_actual==0 and bandera_falla_iniciada==1): 
      enviaAlerta("4CM2 Equipo 7 ' Fin de aberracion detectada (comportamiento anormal), a las: " \
